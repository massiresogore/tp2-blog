<main>
    ...
    <div style="max-width: 700px; margin: 0 auto;">
        ...
        <?php if (isset($_SESSION['Authmessage'])) { ?>
                    <p style="color: #b30000;" class=''><?= isset($_SESSION['Authmessage']) ?  $_SESSION['Authmessage'] : "" ?></p>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="email" value="<?= isset($_SESSION['user'])  ? $_SESSION['user']->getEmail() : "" ?>" name="email" id="email" class="form-control">
                <label for="confirm_email">New Email</label>
            ...
            <button type="submit" class="btn btn-tertiary">Update</button>
